...
/**
 * Provides the local service interface for BaselineInformation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BaselineInformationLocalServiceUtil
...
public interface BaselineInformationLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BaselineInformationLocalServiceUtil} to access the baseline information local service. Add custom service methods to {@link com.liferay.changeset.baseline.service.impl.BaselineInformationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public BaselineInformation addBaselineInformation(long userId, String name);
