...
/**
 * Provides the local service interface for ChangesetBaselineCollection. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ChangesetBaselineCollectionLocalServiceUtil
...
public interface ChangesetBaselineCollectionLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChangesetBaselineCollectionLocalServiceUtil} to access the changeset baseline collection local service. Add custom service methods to {@link com.liferay.changeset.service.impl.ChangesetBaselineCollectionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ChangesetBaselineCollection createChangesetBaselineCollection(
	...
	*/
	...
	public ChangesetBaselineCollection deleteChangesetBaselineCollection(
		ChangesetBaselineCollection changesetBaselineCollection);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ChangesetBaselineCollection deleteChangesetBaselineCollection(
		long changesetBaselineCollectionId) throws PortalException;
	...
	*/
	...
	public ChangesetBaselineCollection fetchChangesetBaselineCollection(
		long changesetBaselineCollectionId);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Optional<ChangesetBaselineCollection> getChangesetBaselineCollectionByName(
		String name);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ChangesetBaselineCollection> getChangesetBaselineCollections(
		int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ChangesetBaselineCollection updateChangesetBaselineCollection(
		ChangesetBaselineCollection changesetBaselineCollection);
}