...
/**
 * The persistence utility for the changeset baseline collection service. This utility wraps {@link com.liferay.changeset.service.persistence.impl.ChangesetBaselineCollectionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class ChangesetBaselineCollectionUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(changesetBaselineCollection);
	}
	 ...
	 */
	public static List<ChangesetBaselineCollection> findWithDynamicQuery(
	 ...
	 */
	public static ChangesetBaselineCollection update(
		ChangesetBaselineCollection changesetBaselineCollection) {
		return getPersistence().update(changesetBaselineCollection);
	}
	...
	public static ChangesetBaselineCollection update(
		...
		return getPersistence()
				   .update(changesetBaselineCollection, serviceContext);
	}
	...
	*/
	public static ChangesetBaselineCollection findByName(String name)
		throws com.liferay.changeset.exception.NoSuchBaselineCollectionException {
	...
	*/
	public static ChangesetBaselineCollection fetchByName(String name) {
	...
	*/
	public static ChangesetBaselineCollection removeByName(String name)
		throws com.liferay.changeset.exception.NoSuchBaselineCollectionException {
	...
	*/
	public static void cacheResult(
		ChangesetBaselineCollection changesetBaselineCollection) {
		getPersistence().cacheResult(changesetBaselineCollection);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(changesetBaselineCollections);
	}
	...
	*/
	public static ChangesetBaselineCollection create(
		long changesetBaselineCollectionId) {
		return getPersistence().create(changesetBaselineCollectionId);
	}
	...
	*/
	public static ChangesetBaselineCollection remove(
		long changesetBaselineCollectionId)
		throws com.liferay.changeset.exception.NoSuchBaselineCollectionException {
		return getPersistence().remove(changesetBaselineCollectionId);
	}

	public static ChangesetBaselineCollection updateImpl(
		ChangesetBaselineCollection changesetBaselineCollection) {
		return getPersistence().updateImpl(changesetBaselineCollection);
	}
	...
	* @throws NoSuchBaselineCollectionException if a changeset baseline collection with the primary key could not be found
	*/
	public static ChangesetBaselineCollection findByPrimaryKey(
		long changesetBaselineCollectionId)
		throws com.liferay.changeset.exception.NoSuchBaselineCollectionException {
		return getPersistence().findByPrimaryKey(changesetBaselineCollectionId);
	}
	...
	*/
	public static ChangesetBaselineCollection fetchByPrimaryKey(
		long changesetBaselineCollectionId) {
		return getPersistence().fetchByPrimaryKey(changesetBaselineCollectionId);
	}

	public static java.util.Map<java.io.Serializable, ChangesetBaselineCollection> fetchByPrimaryKeys(
	...
	*/
	public static List<ChangesetBaselineCollection> findAll() {
	...
	*/
	public static List<ChangesetBaselineCollection> findAll(int start, int end) {
	...
	*/
	...
	public static ChangesetBaselineCollectionPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<ChangesetBaselineCollectionPersistence, ChangesetBaselineCollectionPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ChangesetBaselineCollectionPersistence.class);

		ServiceTracker<ChangesetBaselineCollectionPersistence, ChangesetBaselineCollectionPersistence> serviceTracker =
			new ServiceTracker<ChangesetBaselineCollectionPersistence, ChangesetBaselineCollectionPersistence>(bundle.getBundleContext(),
				ChangesetBaselineCollectionPersistence.class, null);
