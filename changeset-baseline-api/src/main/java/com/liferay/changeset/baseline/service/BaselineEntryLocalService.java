...
/**
 * Provides the local service interface for BaselineEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BaselineEntryLocalServiceUtil
...
public interface BaselineEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BaselineEntryLocalServiceUtil} to access the baseline entry local service. Add custom service methods to {@link com.liferay.changeset.baseline.service.impl.BaselineEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public BaselineEntry addBaselineEntry(long baselineInformationId,
