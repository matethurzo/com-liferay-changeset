 ...
 */
public class ChangesetAwareIndexer implements Indexer {

	public ChangesetAwareIndexer(Indexer indexer) {
		_indexer = indexer;
	}
	...
	@Override
	public void delete(Object object) throws SearchException {
	...
	@Override
	public Document getDocument(Object object) throws SearchException {
		DocumentModelMapper<Object> documentModelMapper =
			DocumentModelMapperRegistryUtil.getDocumentModelMapper(
				_indexer.getClassName());

		Document mappedDocument = documentModelMapper.map(object);

		Document document = _indexer.getDocument(object);

		mappedDocument.getFields().forEach((key, field) -> document.add(field));
	...
	@Override
	public void reindex(Collection objects) throws SearchException {
		_indexer.reindex(objects);
	}

	@Override
	public void reindex(Object object) throws SearchException {
