...
/**
 * Provides the local service interface for ChangesetBaselineEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ChangesetBaselineEntryLocalServiceUtil
...
public interface ChangesetBaselineEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChangesetBaselineEntryLocalServiceUtil} to access the changeset baseline entry local service. Add custom service methods to {@link com.liferay.changeset.service.impl.ChangesetBaselineEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
